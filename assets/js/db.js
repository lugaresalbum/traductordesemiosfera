export const TRANSLATION_DB = [
    ...
    // 5. NORAH (ESTADOS CIVIL/FAMILIAR)
    {
    ...
    // 7. FIGURAS POLÍTICAS (ROSAS / PERÓN)
    {
    ...
    // 8. MODELOS NARRATIVOS (CONRAD / DOSTOIEVSKI)
    {
        term: "Joseph Conrad",
        sourceYear: 1969,
        targetYear: 1914,
    ...
    // 9. CONCEPCIÓN HISTÓRICA (INDIVIDUOS / MASA)
    {
        term: "Individuos",
        sourceYear: 1969,
        targetYear: 1914,
    ...
    // 11. REFERENTES POÉTICOS (HUGO / WHITMAN)
    {
        term: "Victor Hugo",
        sourceYear: 1969,
        targetYear: 1914,
